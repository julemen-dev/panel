...
Route::group(['prefix' => 'servers'], function () {
    ...
    Route::post('/view/{server}/mounts', 'ServersController@newMount');
    ...
    Route::delete('/view/{server}/mounts/{mount}/delete', 'ServersController@deleteMount')->name('admin.servers.view.database.delete');
});
